...
export default function SignupPage() {
  ...
  return (
    <>
      <Head>
        <title>Sign Up - PropPal</title>
        <meta name="description" content="Create your PropPal account" />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Join PropPal and find your dream property</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition-colors">
